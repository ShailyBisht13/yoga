      ...
      <div className="mx-auto max-w-[1320px] px-6 pt-[100px] pb-[100px]">
        ...
        >
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {statItems.map((item, index) => (
              ...
              >
                {index > 0 && (
                  <div className="absolute left-0 top-1/2 hidden h-12 w-px -translate-y-1/2 bg-[#E8E0D4]/60 lg:block" />
                )}
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#4F6F52]/5 text-[#4F6F52] transition-all duration-300 group-hover:bg-[#4F6F52] group-hover:text-white">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <motion.span
              variants={fadeUp}
              className="mb-5 inline-block rounded-full border border-[#A98C5A]/30 bg-[#A98C5A]/10 px-4 py-1.5 font-body text-[11px] font-semibold uppercase tracking-[0.18em] text-[#A98C5A]"
            >
            ...
            <motion.div variants={fadeUp} className="mt-8 space-y-4">
              {featurePoints.map((point) => (
                <div key={point} className="flex items-start gap-3">
                  <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#4F6F52]/10 text-[#4F6F52]">
            ...
            <motion.div variants={fadeUp} className="mt-10">
              <Link
                to="/about"
                className="group inline-flex items-center gap-2.5 rounded-full bg-[#4F6F52] px-8 py-3.5 font-body text-sm font-semibold text-white shadow-soft transition-all duration-300 hover:bg-[#3D5640] hover:shadow-card"
              >
                Learn More
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <p className="font-heading text-2xl font-bold text-[#4F6F52]">
                  500+
                </p>
